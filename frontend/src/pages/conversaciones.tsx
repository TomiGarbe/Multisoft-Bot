  ...
  return (
    <AppLayout>
      <div className="flex min-h-0 flex-1 flex-col overflow-hidden">
        ...
        <div className="chat-layout flex min-h-0 flex-1 overflow-hidden max-md:flex-col">
          <div className={`${showListOnMobile ? 'max-md:flex' : 'max-md:hidden'} h-full min-h-0 md:flex`}>
